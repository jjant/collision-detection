...
var $author$project$ConfigSchema$generateFile = _Platform_outgoingPort(
	'generateFile',
	function ($) {
		var a = $.a;
		var b = $.b;
		...
		A2(
			...
			function (_v0) {
				...
				if (kind.$ === 'CustomKind') {
					...
					return $elm$core$Maybe$Just(logicName);
				} else {
					return $elm$core$Maybe$Nothing;
				}
			},
...
var $jjant$unwrap$Unwrap$boom1 = function (_v1) {
	return $jjant$unwrap$Unwrap$boom2(_Utils_Tuple0);
};
var $jjant$unwrap$Unwrap$boom2 = function (_v0) {
	return $jjant$unwrap$Unwrap$boom1(_Utils_Tuple0);
};
...
var $author$project$ConfigFormGenerator$regex = A2($elm$core$Basics$composeR, $elm$regex$Regex$fromString, $jjant$unwrap$Unwrap$maybe);
var $elm$regex$Regex$replace = _Regex_replaceAtMost(_Regex_infinity);
var $author$project$ConfigFormGenerator$interpolate = F2(
	function (pattern, word) {
		return A2(
			$elm$regex$Regex$replace,
			$author$project$ConfigFormGenerator$regex(pattern),
			function (_v0) {
				return word;
			});
	});
...
var $author$project$ConfigFormGenerator$uncapitalize = function (str) {
	return _Utils_ap(
		$elm$core$String$toLower(
			A2($elm$core$String$left, 1, str)),
		A2($elm$core$String$dropLeft, 1, str));
};
var $author$project$ConfigFormGenerator$customLogics = function (kinds) {
	return A2(
		$elm$core$String$join,
		'\n\n',
		$elm$core$Set$toList(
			A2(
				$elm$core$Set$map,
				function (kind) {
					var typeName = $author$project$ConfigFormGenerator$customTypeName(kind);
					var templateStr = '$funcName : String -> String -> (config -> $typeName) -> ($typeName -> config -> config) -> Logic logicKind\n$funcName fieldName label getter setter =\n    { fieldName = fieldName\n    , label = label\n    , kind = $logicConstructorName { getter = getter, setter = setter }\n    }';
					var logicConstructorName = kind + 'Logic';
					var funcName = $author$project$ConfigFormGenerator$uncapitalize(kind);
					return A3(
						$author$project$ConfigFormGenerator$interpolate,
						...
						A3(
							...
							'\\$typeName',
							typeName,
							A3($author$project$ConfigFormGenerator$interpolate, '\\$funcName', funcName, templateStr)));
				},
...
var $author$project$ConfigFormGenerator$kindToDefault = function (kind) {
	switch (kind.$) {
		case 'IntKind':
			return $elm$core$Maybe$Just('defaults.int');
		case 'FloatKind':
			return $elm$core$Maybe$Just('defaults.float');
		case 'StringKind':
			return $elm$core$Maybe$Just('defaults.string');
		case 'BoolKind':
			return $elm$core$Maybe$Just('defaults.bool');
		case 'ColorKind':
			return $elm$core$Maybe$Just('defaults.color');
		case 'SectionKind':
			return $elm$core$Maybe$Nothing;
		default:
			var logicName = kind.a.logicName;
			return $elm$core$Maybe$Just(
				'defaults.' + $author$project$ConfigFormGenerator$uncapitalize(logicName));
	}
};
var $author$project$ConfigFormGenerator$kindToFieldName = function (kind) {
	switch (kind.$) {
		case 'IntKind':
			var str = kind.a;
		...
		case 'SectionKind':
			return $elm$core$Maybe$Nothing;
		default:
			var fieldName = kind.a.fieldName;
			return $elm$core$Maybe$Just(fieldName);
	}
};
var $author$project$ConfigFormGenerator$emptyEntry = function (kind) {
	var _v0 = _Utils_Tuple2(
		$author$project$ConfigFormGenerator$kindToFieldName(kind),
		$author$project$ConfigFormGenerator$kindToDefault(kind));
	if ((_v0.a.$ === 'Just') && (_v0.b.$ === 'Just')) {
		var fieldName = _v0.a.a;
		var _default = _v0.b.a;
		return $elm$core$Maybe$Just(fieldName + (' = ' + _default));
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
	...
	var middle = A2(
		...
		A2(
			...
			F2(
				function (i, entry) {
					var pre_ = (!i) ? '    { ' : '    , ';
					return _Utils_ap(pre_, entry);
				}),
			A2(
				$elm$core$List$filterMap,
				$author$project$ConfigFormGenerator$emptyEntry,
...
var $author$project$ConfigFormGenerator$logicKindType = function (kinds) {
	var defaultKinds = _List_fromArray(
		[
			_Utils_Tuple2('Int', 'Int'),
			_Utils_Tuple2('Float', 'Float'),
			_Utils_Tuple2('String', 'String'),
			_Utils_Tuple2('Color', 'Color'),
			_Utils_Tuple2('Bool', 'Bool'),
			_Utils_Tuple2('Section', '()')
		]);
	return 'type LogicKind config\n' + ('    = ' + A2(
		$elm$core$String$join,
		'\n    | ',
		A2(
			$elm$core$List$map,
			...
			_Utils_ap(
				...
				A2(
					...
					function (k) {
						return _Utils_Tuple2(
							k,
							$author$project$ConfigFormGenerator$customTypeName(k));
					},
					$elm$core$Set$toList(
						$author$project$ConfigFormGenerator$gatherCustomTypes(kinds)))))));
};
var $author$project$ConfigFormGenerator$kindToLogic = function (kind) {
	switch (kind.$) {
		case 'IntKind':
			return 'ConfigForm.int';
		case 'FloatKind':
			return 'ConfigForm.float';
		case 'StringKind':
			return 'ConfigForm.string';
		case 'BoolKind':
			return 'ConfigForm.bool';
		case 'ColorKind':
			return 'ConfigForm.color';
		case 'SectionKind':
...
var $author$project$ConfigFormGenerator$kindToLogicArgs = function (_v0) {
	var label = _v0.a;
	var kind = _v0.b;
	var _v1 = $author$project$ConfigFormGenerator$kindToFieldName(kind);
	if (_v1.$ === 'Just') {
		var fieldName = _v1.a;
		var setter = '(\\a c -> { c | ' + (fieldName + ' = a })');
		var labelLine = '\"' + (label + '\"');
		var getter = '.' + fieldName;
		var fieldLine = '\"' + (fieldName + '\"');
		return _List_fromArray(
			[fieldLine, labelLine, getter, setter]);
	} else {
		return _List_fromArray(
			['\"' + (label + '\"')]);
	}
		...
		A2(
			...
			F2(
				function (i, _v0) {
					var label = _v0.a;
					var kind = _v0.b;
					var pre_ = (!i) ? ('    [ ' + $author$project$ConfigFormGenerator$kindToLogic(kind)) : ('    , ' + $author$project$ConfigFormGenerator$kindToLogic(kind));
					var args = A2(
						$elm$core$List$map,
						function (str) {
							return '        ' + str;
						},
						$author$project$ConfigFormGenerator$kindToLogicArgs(
							_Utils_Tuple2(label, kind)));
					return A2(
						$elm$core$String$join,
						'\n',
						A2($elm$core$List$cons, pre_, args));
				}),
			data));
	return A2(
		$elm$core$String$join,
...
var $author$project$ConfigFormGenerator$kindToType = function (kind) {
	switch (kind.$) {
		case 'IntKind':
		...
		default:
			var logicName = kind.a.logicName;
			return $elm$core$Maybe$Just('ConfigForm.Custom.' + logicName);
	}
};
var $author$project$ConfigFormGenerator$typeAliasEntry = function (kind) {
	var _v0 = _Utils_Tuple2(
		$author$project$ConfigFormGenerator$kindToFieldName(kind),
		$author$project$ConfigFormGenerator$kindToType(kind));
	if ((_v0.a.$ === 'Just') && (_v0.b.$ === 'Just')) {
		var fieldName = _v0.a.a;
		var type_ = _v0.b.a;
		return $elm$core$Maybe$Just(fieldName + (' : ' + type_));
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
var $author$project$ConfigFormGenerator$typeAlias = function (data) {
	var pre = 'type alias Config =';
	var post = '    }';
	var middle = A2(
		$elm$core$String$join,
		'\n',
		A2(
			...
			A2(
				$elm$core$List$filterMap,
				$author$project$ConfigFormGenerator$typeAliasEntry,
				A2($elm$core$List$map, $elm$core$Tuple$second, data))));
	return A2(
		$elm$core$String$join,
		'\n',
...
_Platform_export({'ConfigSchema':{'init':$author$project$ConfigSchema$main(
